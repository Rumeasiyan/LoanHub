    ...
    <div class="bg-white shadow-md rounded-lg p-8 w-full sm:w-96">
        ...
        @endif
            ...
            <div class="mb-4">
                ...
                <input name="password" type="password" id="password" placeholder="Password" class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200 focus:border-blue-300 p-2">
            </div>
